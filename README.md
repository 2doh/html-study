...
- section 태그 : 웹 문서의 콘텐츠 영역을 나타냄, article은 독립된 콘텐츠, section은 몇 개의 콘텐츠 묶는 용도
...
<html lang="ko">
  ...
  <body>
    ...
    <main>
      <section>
        <h2>몸과 마음 치유되는 섬</h2>
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laborum ab sed
        adipisci vitae beatae officia nesciunt asperiores vel odio quisquam
        eligendi quos ipsum dolore est illum deserunt, laboriosam dignissimos
        suscipit.
...
- 순서 있는 목록 ol, li
- 순서가 없는 목록 ul, li
- 설명 목록을 만드는 dl, dt, dd 태그 : dl : description, dt : 제목, dd : 값(설명)
...
<img src="images/salad.jpg" width="50%" />
<img src="images/salad.jpg" width="150" />
```
...
```html
    ...
    <div>
      <video src="medias/salad.mp4" controls width="700" />
    </div>
    <div>
...
- input 태그의 type 속성
  ...
  - datetime-loca : 사용자 지역을 기준으로 datetime
  - submit : 전송 버튼
  - reset : 리셋 버튼
...
<body>
  ...
  <select>
    ...
    <option value="4">항정살</option>
    <option value="5">가브리살</option></select
  >```
</body>
````
